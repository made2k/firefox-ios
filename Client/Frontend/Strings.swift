...
extension Strings {
    ...
    public static let TrackingProtectionOptionBlockListTypeAdguard = NSLocalizedString("Settings.TrackingProtectionOption.Adguard", value: "Adguard", comment: "Adguard enabled block lists.")
    public static let TrackingProtectionOptionBlockListTypeAdguardDescription = NSLocalizedString("Settings.TrackingProtectionOption.AdguardDescription", value: "Blocks page elements and trackers.", comment: "Adguard enabled block lists description.")
