...
//                    ContentBlockerHelper.compileAdguardLists {
...
//            AdguardLoader.shared.getLists().done { results in
//                for result in results {
//                    self.addToTab(contentRuleList: result)
//                }
//            }
//            return
//        }
...
//    // MARK: - Adguard
//
//    private static func compileAdguardLists(completion: @escaping () -> Void) {
//        AdguardLoader.shared.getLists().done { _ in
//            completion()
//        }.cauterize()
//    }
//
